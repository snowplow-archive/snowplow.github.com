...
This contrasts with the situation in analytics systems like Google Analytics and Adobe Analytics (SiteCatalyst), where you have to map your different objects (in this case your user and article object) into a set of custom dimension, sProp or eVar fields. Both GA and Adobe Analytics force you to create a new schema for your data, and maintain a mapping layer with its own internal logic for moving data from your application code into your analytics system. This introduces both complexity and fragility into your data pipeline. Having an analytics system that lets you pass data without introducing a new model, schema and transformation step is simpler, faster and more robust.
