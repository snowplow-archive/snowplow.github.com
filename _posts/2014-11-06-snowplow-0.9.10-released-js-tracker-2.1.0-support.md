...
We are pleased to announce the release of Snowplow 0.9.10. This is a minimalistic release designed to support the new Snowplow JavaScript Tracker v2.1.1, also [released today] [js-tracker-release]
...
1. [New Redshift tables](/blog/2014/11/06/snowplow-0.9.10-released-with-js-tracker-2.1.0-support/#redshift-ddl)
2. [New JSON Path files](/blog/2014/11/06/snowplow-0.9.10-released-with-js-tracker-2.1.0-support/#json-paths-files)
3. [A note on link_clicks](/blog/2014/11/06/snowplow-0.9.10-released-with-js-tracker-2.1.0-support/#)
4. [Upgrading](/blog/2014/11/06/snowplow-0.9.10-released-with-js-tracker-2.1.0-support/#upgrading)
5. [Documentation and help](/blog/2014/11/06/snowplow-0.9.10-released-with-js-tracker-2.1.0-support/#help)
