...
2. Now if there are no rows to process, EmrEtlRunner correctly returns a 0, not a 1 as before ([#1018] [issue-1018])
...
You need to update EmrEtlRunner and StorageLoader to the latest code (0.9.9 release) on GitHub:
