...
3. [Funnel analysis on Snowplow data](#funnel) // is it really analysis, shouldn't I just say data modelling the funnel journey ?
...
We define a [SparkContext](https://spark.apache.org/docs/1.3.1/api/scala/index.html#org.apache.spark.SparkContext):
