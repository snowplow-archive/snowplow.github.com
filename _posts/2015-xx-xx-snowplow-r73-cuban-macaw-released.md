...
4. [Upgrading](/blog/2015/12/04/snowplow-r73-cuban-macaw-released#upgrading)
5. [More performant handling of missing schemas](/blog/2015/12/04/snowplow-r73-cuban-macaw-released#missing-schemas)
...
This release brings to our batch pipeline a feature only previously available in our Kinesis pipeline: the ability to load your Snowplow bad rows from Amazon S3 into Elasticsearch.

This functionality is hugely powerful for diagnosing incoming events that fail validation and investigating enrichment processing errors. We have tested this feature with Elasticsearch running natively on EC2, as well as with the excellent new [Amazon Elasticsearch Service] [amazon-es]. Here's a screengrab of us diagnosing bad rows for an internal Snowplow pipeline:
