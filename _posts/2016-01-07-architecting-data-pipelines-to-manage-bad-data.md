...
3. [Architecting auditable pipelines](/blog/2016/01/07/architecting-data-pipelines-to-manage-bad-data/#auditing-pipelines)
4. [Reprocessing data from scratch](/blog/2016/01/07/architecting-data-pipelines-to-manage-bad-data/#reprocess)
...
We've taken exactly the same approach with the Snowplow pipeline: you can always reprocess your data from scratch. (Starting with the raw collector logs.) That means you can both:

1. Reprocess a particular time period of data (or even your entire data set) if e.g. a step in the pipeline was miconfigured
...
When we diligencing data quality, we need more than just the data itself, we need metadata that describes:
